...
var KiiJQueryHttpRequest, KiiRequest, KiiTitaniumHttpRequest, KiiUtilities, KiiXMLHttpRequest, root, _Kii, _KiiSocialConnect,
...
root.KiiACL = (function() {
  ...
  KiiACL.prototype._saveItr = function(idx, callbacks) {
    var aclEntry, path, request, _errorStr, _this;
    _this = this;
      ...
      success: (function(_this) {
        return function(data, statusCode) {
          ...
          if (statusCode < 300 && statusCode >= 200) {
            ...
            if (callbacks != null) {
              return callbacks.success(_thisBucket, query, count);
            }
          } else if (callbacks != null) {
            return callbacks.failure(_thisBucket, query, "Unable to parse response");
          }
        };
      })(this),
      failure: (function(_this) {
...
root.KiiGroup = (function() {
  ...
  KiiGroup.prototype.addUser = function(member) {
    var ndx;
    if (this._addMembers.indexOf(member === -1)) {
      this._addMembers.push(member);
    }
    ndx = this._removeMembers.indexOf(member);
    if (ndx >= 0) {
  ...
  KiiGroup.prototype.removeUser = function(member) {
    var ndx;
    if (this._removeMembers.indexOf(member === -1)) {
      this._removeMembers.push(member);
    }
    ndx = this._addMembers.indexOf(member);
    if (ndx >= 0) {
  ...
  KiiGroup.prototype._addMember = function(member, callback) {
    ...
    memberCallbacks = {
      success: (function(_this) {
        return function(data, statusCode) {
          var ndx;
          ndx = _thisGroup._getAddMembers().indexOf(member);
      ...
      failure: (function(_this) {
        return function(error, statusCode) {
          var ndx;
          ndx = _thisGroup._getRemoveMembers().indexOf(member);
          KiiUtilities.arrayRemove(_thisGroup._getAddMembers(), ndx, ndx);
  ...
  KiiRequest.prototype.execute = function(callbacks, ignoreBody) {
    ...
    callbacks = {
      onComplete: (function(_this) {
        return function() {
          var e, errString, error, json, xhr, _ref1;
              ...
              if (_this._ignoreBody) {
                ...
                if (json != null) {
                  if (json.errorCode != null) {
                    ...
                    return _this._success(json, xhr.status);
                  }
                } else {
...
root.KiiSCNFacebook = (function(_super) {
  ...
  KiiSCNFacebook.prototype._register = function(token, expires) {
    var registrationCallbacks, request, _this;
    _this = this;
  ...
  KiiSCNFacebook.prototype._link = function(token, expires) {
    var linkCallbacks, request, _this;
    _this = this;
  ...
  KiiSCNFacebook.prototype._unlink = function() {
    var request, unlinkCallbacks, _this;
    _this = this;
...
root.KiiSCNTwitter = (function(_super) {
  ...
  KiiSCNTwitter.prototype._register = function(options, callbacks) {
    var data, registrationCallbacks, request, _this;
    _this = this;
  ...
  KiiSCNTwitter.prototype._link = function(options, callbacks) {
    var data, linkCallbacks, request, _this;
    _this = this;
...
KiiTitaniumHttpRequest = (function() {
  KiiTitaniumHttpRequest.xhr = null;
